        ...
        <ScrollView style={styles.back} contentContainerStyle={{ paddingBottom: 20 }}>
            ...
            {/* person details */}
            {
                ...
                <View>
                    ...
                    <View style={{ marginHorizontal: 10, marginTop: 18, paddingHorizontal: 6, paddingVertical: 15, justifyContent: 'space-between', flexDirection: 'row', alignItems: "center", backgroundColor: '#6F7676', borderRadius: 80 }}>
                        <View style={{ paddingHorizontal: 8, borderRightWidth: 2, borderRightColor: 'white' }}>
                            <Text style={styles.text2}>Gender</Text>
                            <Text style={styles.text3}>{person?.gender==1 ? 'Female' : 'Male'}</Text>
                        </View>
                        <View style={{ paddingHorizontal: 8, borderRightWidth: 2, borderRightColor: 'white' }}>
                        ...
                        <View style={{ paddingHorizontal: 8 }}>
                            ...
                            <Text style={styles.text3}>{person?.popularity?.toFixed(2)}%</Text>
                        </View>
                    </View>
